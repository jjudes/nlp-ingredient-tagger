...
Given a sequence of words *W1, W2, W3, ..., Wn* and some possible labels for these words, what is the best *sequence* of labels *Y1, Y2, Y3, ..., Yn* (where each *Yi* is one of *C1, C2, ..., Ck*).
